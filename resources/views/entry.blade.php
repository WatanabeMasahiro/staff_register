...
<div class="container mainContents">    <!-- mainContents -->
    ...
    <table class="noset-table table table-hover table-dark recordTable">
        <tr class="recordData table-secondary text-dark">
            <th colspan="2" class="ml-2 py-0 align-middle" style="font-size: 0.9em;">日時昇順（<i class="far fa-clock"></i>）</th>
        </tr>
        @foreach($m_ids as $matter)
    ...
    <div class="paginate d-flex justify-content-center my-5">{{$m_ids->appends(request()->input())->links('vendor.pagination.bootstrap-4')}}</div>
